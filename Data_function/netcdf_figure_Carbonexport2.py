...
file1_ALT=nc('/media/natalia/DATA/Documentos/TesisI/SPIN/cgenie_output/worjh2.PO4Fe_Mahowald2006_DUST_ALT/biogem/fields_biogem_2d.nc')
file1_OLD=nc('/media/natalia/DATA/Documentos/TesisI/SPIN/cgenie_output/worjh2.PO4Fe_Mahowald2006_DUST_OLD/biogem/fields_biogem_2d.nc')

file2=nc('/media/natalia/DATA/Documentos/TesisI/SPIN/cgenie_output/worjh2.PO4Fe_Mahowald2006_ALT/biogem/fields_biogem_2d.nc') # this line defines the file path of the file we are trying to read
file3=nc('/media/natalia/DATA/Documentos/TesisI/SPIN/cgenie_output/worjh2.PO4Fe_Mahowald2006_OLD/biogem/fields_biogem_2d.nc') # this line defines the file path of the file we are trying to read
file4=nc('/media/natalia/DATA/Documentos/TesisI/SPIN/cgenie_output/worjh2.PO4Fe_Mahowald2006_FeFe2LFeL/biogem/fields_biogem_2d.nc') # this line defines the file path of the file we are trying to read
...
plt.subplot(421)
m.drawcoastlines()
Exp_H1 = m.contourf(x,y,Exp1_median_ALT,500,vmin=0.0491,vmax=4.472,cmap=cmap) #vmin=0.04, vmax=4.5
...
plt.subplot(423)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp2_median,500,vmin=0.0491,vmax=4.472,cmap=cmap) #vmin=0.04, vmax=4.5
...
plt.subplot(425)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp_ALT2,500,vmin=-0.385,vmax=0.736,cmap=cmap) #vmin=-0.69, vmax=0.35, 
ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
ExpLGM_H1.set_label('mol m-2 yr-1', rotation=90)
plt.xlabel('Longitude',color='gray')
plt.ylabel('Latitude',color='gray')
...
plt.subplot(427)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp_perc_ALT2,500,vmin=-14.89,vmax=21.151,cmap=cmap) 
ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
...
#plt.subplot(429)
#m.drawcoastlines()
#ExpLGM_H1 = m.contourf(x,y,100*(Exp2_median-Exp1_median_OLD)/Exp2_median,500,vmin=-26.83,vmax=21.16,cmap=cmap) 
#ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
#ExpLGM_H1.set_label('%', rotation=90)
#plt.xlabel('Longitude',color='gray')
#plt.ylabel('Latitude',color='gray')
...
plt.subplot(422)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp1_median_OLD,500,vmin=0.0491,vmax=4.472,cmap=cmap) #vmin=0.04, vmax=4.5
ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
ExpLGM_H1.set_label('mol m-2 yr-1', rotation=90)
plt.xlabel('Longitude',color='gray')
plt.ylabel('Latitude',color='gray')
...
plt.subplot(424)
m.drawcoastlines()
Exp_H2 = m.contourf(x,y,Exp3_median,500,vmin=0.0491,vmax=4.472,cmap=cmap) #vmin=0.04, vmax=4.5, 
...
plt.subplot(426)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp_OLD2,500,vmin=-0.385,vmax=0.736,cmap=cmap) #vmin=-0.69, vmax=0.35, 
ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
ExpLGM_H1.set_label('mol m-2 yr-1', rotation=90)
plt.xlabel('Longitude',color='gray')
plt.ylabel('Latitude',color='gray')
...
plt.subplot(428)
m.drawcoastlines()
ExpLGM_H1 = m.contourf(x,y,Exp_perc_OLD2,500,vmin=-14.89,vmax=21.151,cmap=cmap) 
ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
ExpLGM_H1.set_label('%', rotation=90)
plt.xlabel('Longitude',color='gray')
plt.ylabel('Latitude',color='gray')
...
#plt.subplot(5,2,10)
#m.drawcoastlines()
#ExpLGM_H1 = m.contourf(x,y,100*(Exp3_median-Exp1_median_OLD)/Exp3_median,500,vmin=-26.83,vmax=21.16,cmap=cmap) 
#ExpLGM_H1=plt.colorbar(ExpLGM_H1,orientation="vertical")
#ExpLGM_H1.set_label('%', rotation=90)
#plt.xlabel('Longitude',color='gray')
#plt.ylabel('Latitude',color='gray')
...
plt.savefig('/media/natalia/DATA/Documentos/TesisI/Presentación12-08/figuras/figure_Carbonexport2.pdf')
...
Exp_R1 = m.pcolor(x,y,(Exp1_median_ALT-Exp1_median_OLD),vmin=-0.111, vmax=0.042,cmap=cmap) #vmin=-0.69, vmax=0.35, ,norm=midnorm 
...
plt.subplot(232)
m.drawcoastlines()
Exp_R2 = m.pcolor(x,y,(Exp2_median-Exp3_median),vmin=-0.111, vmax=0.042,cmap=cmap) 
...
plt.subplot(234)
m.drawcoastlines()
Exp_R11 = m.pcolor(x,y,100*(Exp1_median_ALT-Exp1_median_OLD)/Exp1_median_ALT,vmin=-8.4, vmax=9.29,cmap=cmap) #vmin=-0.69, vmax=0.35, ,norm=midnorm 
...
plt.subplot(235)
m.drawcoastlines()
Exp_R22 = m.pcolor(x,y,100*(Exp2_median-Exp3_median)/Exp2_median,vmin=-8.4, vmax=9.29,cmap=cmap) 
...
plt.subplots_adjust(hspace=0.4)
plt.savefig('/media/natalia/DATA/Documentos/TesisI/Presentación12-08/figuras/figure_Carbonexport2_differences.pdf')
plt.show()
