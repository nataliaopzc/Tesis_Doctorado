...
file=nc('/home/natalia/Documentos/DATA/TesisI/cgenie/cgenie_output/worjh2.PO4Fe' + name +'H_calculated_Dust.SPIN/biogem/fields_biogem_2d.nc') # this line defines the file path of the file we are trying to read
file_sig=np.genfromtxt('/home/natalia/Documentos/Tesis/Flujos_de_polvo/Globales_Kg/' + name +'/'  + name + '.nc_annualflux_kgperm2pers.36x36_level1.dat') # this line defines the file path of the file we are trying to read
...
print(lon)
###########################################################
file2=nc('/home/natalia/Documentos/DATA/TesisI/cgenie/cgenie_output/worjh2.PO4Fe' + name +'LGM_calculated_Dust.SPIN/biogem/fields_biogem_2d.nc') # this line defines the file path of the file we are trying to read
file_sig2=np.genfromtxt('/home/natalia/Documentos/Tesis/Flujos_de_polvo/Globales_Kg/' + name +'/'  + name + '.nc_annualflux_kgperm2pers.36x36_level10.dat') # this line defines the file path of the file we are trying to read
...
#plt.figure()
plt.figure(num=None, figsize=(8.2, 4.5), dpi=100, facecolor='w', edgecolor='k')
...
plt.savefig('/home/natalia/Documentos/DATA/TesisI/Data_function/Function/' + name + 'read_output_Dust_AeolianIron_and_SolubilizedIron.pdf')
plt.show()