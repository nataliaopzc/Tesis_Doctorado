...
for i in TIME:
	...
	if i == 'H':
		axes2 = figure.add_axes([0.54, 0.15, 0.35, 0.29])
	else:
		axes2 = figure.add_axes([0.2, 0.4, 0.6, 0.29]) #[0.45, 0.4, 0.35, 0.29]
		...
		for k in SOL:
			...
			for xp,yp,m in zip(Sol,CO22,Simbolos):
				...
				if i == 'H':
					...
					axes.set_xticklabels(['-1', '0','1', '2', '3','4','5','6','7','8'],fontsize=14)
				else:
					plt.xlim(0,3.8) #LGM (0,2)
					plt.ylim(-1e-15,1.5e-15) #LGM
					axes.set_xticklabels(['-1','0', '1', '2', '3','4','5','6','7'],fontsize=14)
			axes.set_xlabel('Iron solubility [%]',fontsize=18)
