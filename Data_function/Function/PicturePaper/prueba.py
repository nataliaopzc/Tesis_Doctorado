...
plt.xlabel(r'$ \bf \Delta$' 'pCO' r'$\bf _{2}=pCO_{2LGM}-pCO_{2H}$' ' [ppm]',color='black',fontsize=9, fontweight='bold')
plt.grid(axis='x',linestyle = '--')
plt.legend(handles=legend_elements, loc='upper right',fontsize=9, bbox_to_anchor=(1.25, 1.03))
plt.tick_params(axis='y', left = False)
plt.savefig('/home/natalia/Documentos/DATA/TesisI/Data_function/Function/PicturePaper/Prueba_Figure6_Boxplot_Tabla2.png')