		...
		for k in SOL:
			...
			for xp,yp,m in zip(Sol,CO22,Simbolos):
				...
				if i == 'H':
					...
					plt.ylim(-0.22e-7,0.25e-7) #H
				else:
					plt.xlim(0,1.3) #LGM
					plt.ylim(-0.5e-8,1e-8) #LGM
			axes.set_xlabel('Factor de solubilidad del hierro [%]',fontsize=24)
			axes.set_ylabel('ΔCO2 [ppm kg-1]',fontsize=24)
