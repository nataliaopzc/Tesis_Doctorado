...
ii=0
for i in TIME:
	figure = plt.figure(i,figsize=(8, 6), dpi=100, facecolor='w', edgecolor='k')
...
# 				CO22.append((CO2[l]/Carga1[l])[0])
			bplot=axes.boxplot(CO2,patch_artist=False,positions = [index2[ll]],widths = 0.8)
...
# 					bplot2=axes2.boxplot(CO2,patch_artist=True,positions = [index2[ll]],widths = 0.8)
